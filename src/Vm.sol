...
interface VmSafe {
    ...
    function addr(string calldata privateKey) external pure returns (address keyAddr);
    ...
    // Signs data
    function sign(string calldata privateKey, bytes32 digest) external pure returns (bytes calldata sig);
    ...
    function broadcast(string calldata privateKey) external;
    ...
    function startBroadcast(string calldata privateKey) external;
